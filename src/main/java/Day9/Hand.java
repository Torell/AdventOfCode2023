...
public class Hand {
    ...
    public Hand(LinkedHashMap<Integer, Integer> cards, double bid, double equalScoreSettler) {
        this.cards = cards;
        this.bid = bid;
    ...
    public void calculateHandPower() {
       // System.out.println("-----------------------");
        ...
        // if the hand contains 5 cards, aka get highest card
        if (cards.size() == 5) {
            int highestCard = 0;
            ...
            setHandPower(getHandPower() + (highestCard / 10.0));
        }
